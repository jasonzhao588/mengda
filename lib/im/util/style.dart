class RCColor {
  ...
  static const ConListBorderColor = 0xffdddddd;
  ...
  static const MessageRadius = 10.0;
...
class RCFont {
  //会话列表相关字体大小
  static const double ConListTitleFont = 15;
  static const double ConListTimeFont = 12;
  static const double ConListUnreadFont = 8;
  static const double ConListDigestFont = 13;

  //会话页面，消息相关字体大小
  static const double MessageTextFont = 15;
  static const double MessageTimeFont = 12;
  static const double MessageNameFont = 12;
  static const double MessageNotifiFont = 13;
  ...
  //加号扩展栏
  static const double ExtIconSize = 36;
...
class RCLayout {
  ...
  static const double ConListItemHeight = 72; //会话列表 item 高度
  ...
  //加号扩展栏
  static const double ExtIconLayoutSize = 56;
  static const double ExtentionLayoutWidth = 240;
