...
import 'package:mengda/im/util/dialog_util.dart';
import 'package:mengda/im/util/style.dart';
  ...
  Widget getWidget(Conversation con) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: InkWell(
          child: new ListTile(
            title: new Text(con.targetId),
            leading: con.conversationType == RCConversationType.Private
                ? Container()
                : Container(
                    width: 10,
                    height: 10,
